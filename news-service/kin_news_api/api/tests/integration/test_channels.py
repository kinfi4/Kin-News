...
class TestChannels(TestCase):
    ...
    #
    #     telegram_mock = mock.MagicMock()
    #     tg_channels = [build_telegram_channel_entity() for _ in range(3)]
    ...
    #     channel3 = Channel(link=tg_channels[2].link)
    #     Channel.objects.bulk_create([channel1, channel2, channel3])
    #
    #     channel1.subscribers.add(self._test_user)
    #     channel1.save()
    #     channel3.subscribers.add(self._test_user)
    #     channel3.save()
    #
    #     with (
    #         container.clients.telegram_client.override(telegram_mock)
