...
class MessageService:
    ...
    def get_user_posts(
        ...
        for channel in user_channels:
            ...
            try:
                channel_messages = self._telegram_client.fetch_posts_from_channel(channel.link, offset_date=offset_time, earliest_date=end_time)
        ...
        self._logger.info(f'Total messages found for period: {offset_time}:{end_time} is {len(messages)}')
